    ...
    <div className="bg-white rounded-3xl p-6 max-w-96 shadow-sm font-sans">
      <div className="flex justify-between items-start mb-3">
        <div className="flex gap-3">
          <div className="w-12 h-12 rounded-full bg-gray-300 flex-shrink-0 border overflow-hidden border-gray-100 relative">
            <Image
              src={review.image}
      ...
      <div className="flex items-center gap-1.5 mb-3">
        <div className="flex space-x-[1px] text-[#ffc414]">
