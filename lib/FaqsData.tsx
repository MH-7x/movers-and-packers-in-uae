...
export const HomePageFAQs: FAQData[] = [
  ...
  {
    question: "What is the best moving company in UAE?",
    answer: (
      <>
        <p>
  ...
  {
    question: "How do I hire professional movers in Dubai?",
    answer: (
      <>
        <p>
  ...
  {
    question: "Do moving companies in UAE provide packing materials?",
    answer: (
      <>
        <p>
  ...
  {
    question: "How far in advance should I book a moving company in UAE?",
    answer: (
      <>
        <p>
  ...
  {
    question: "Are movers in UAE insured?",
    answer: (
      <>
        <p>
  ...
  {
    question:
      "What is the difference between an open truck and an enclosed truck for moving?",
    answer: (
      <>
        <p>
  ...
  {
    question: "Do you provide storage services in UAE?",
    answer: (
      <>
        <p>
  ...
  {
    question: "What areas do you cover in the UAE?",
    answer: (
      <>
        <p>
...
export const ArDubaiMoversFaqs: {
  question: string;
...
}[] = [
  {
    ...
    answer: (
      <p>
        تكلفة نقل اثاث دبي تبدأ من حوالي ٩٠٠ درهم لشقة استوديو وترتفع إلى ٣٥٠٠
        درهم أو أكثر لفيلا كبيرة. العوامل الرئيسية التي تحدد السعر هي: حجم
        الوحدة وعدد القطع، الطابق في حالة الأبراج، المسافة بين الموقع الحالي
        والجديد، وما إذا كنت تحتاج تغليفاً كاملاً أو ستغلف بنفسك. تواصل معنا
        للحصول على رقم دقيق لحالتك.
      </p>
    ),
  },
  {
    question: "هل يمكنني الدفع بعد الانتهاء من النقل؟",
    answer: (
      <p>
        نعم. الدفع بعد الانتهاء ورضاك التام هو سياستنا الأصلية منذ البداية. لا
        نطلب دفعة مقدمة في أي مرحلة. نقبل النقد، التحويل البنكي، والشيك المصرفي.
      </p>
    ),
  },
  {
    question: "هل تتوفر لديكم شاحنات مغلقة في دبي؟",
    answer: (
      <p>
        نعم. كل أسطولنا شاحنات بوكس مغلقة بالكامل، معتمدة من هيئة الطرق
        والمواصلات (RTA). هذا مهم بشكل خاص في دبي نظراً لحرارة الصيف التي تتجاوز
        ٤٥ درجة مئوية والعواصف الرملية المتكررة التي تتلف الأثاث في الشاحنات
        المكشوفة.
      </p>
    ),
  },
  {
    question: "هل تعملون على نقل اثاث في نفس اليوم؟",
    answer: (
      <p>
        في أغلب الأحيان نعم. إذا كانت حاجتك عاجلة، تواصل معنا فوراً وسنرى ما
        يمكن ترتيبه. خدمة نقل عاجل لها أولوية عندنا لمن يكون في وضع طارئ.
      </p>
    ),
  },
  {
    question: "هل تنقلون الأثاث من الشارقة أو عجمان إلى دبي؟",
    answer: (
      <p>
        نعم. نقل اثاث الشارقة دبي وعجمان إلى دبي ضمن خدماتنا اليومية. السعر يشمل
        رسوم الطريق السريع ولا يوجد أي مبلغ إضافي مفاجئ. تواصل معنا لعرض سعر على
        المسار بين الإمارات.
      </p>
    ),
  },
  {
    question: "هل الأسعار نهائية ولا توجد رسوم خفية؟",
    answer: (
      <p>
        نعم. العرض الذي يصلك على واتساب أو الإيميل هو المبلغ النهائي. لا رسوم
        خفية ولا أي إضافات يوم النقل. إذا تغير شيء في التفاصيل بعد إرسال العرض،
        نُخبرك أولاً قبل أي تعديل.
      </p>
    ),
  },
  {
    question: "كيف أتحقق أن شركتكم موثوقة قبل أن أتصل؟",
    answer: (
      <p>
        الشركة مسجلة رسمياً منذ ١٩٩٨ ولديها ملف Google Business موثق على خرائط
        جوجل مع العنوان الفعلي في راس الخور الصناعية ١ والتقييمات الحقيقية من
        عملاء سابقين. يمكنك مراجعة كل هذا قبل أن تتخذ أي قرار.{" "}
        <a href="https://www.google.com/maps/place/?q=place_id:ChIJ8UeWa_JnXz4RG24rN_JJolE">
...
export const ArSharjahMoversFaqs: {
  question: string;
  answer: React.ReactNode;
}[] = [
  {
    question: "كم تكلفة نقل الأثاث داخل الشارقة؟",
    answer: (
      <p>
  ...
  {
    question: "هل تقدمون خدمة فك وتركيب الأثاث والستائر؟",
    answer: (
      <p>
  ...
  {
    question: "هل الأثاث مؤمن عليه أثناء عملية النقل؟",
    answer: (
      <p>
  ...
  {
    question: "ما الفرق بين الشاحنة المغلقة والشاحنة المفتوحة؟",
    answer: (
      <p>
  ...
  {
    question: "متى يتم دفع تكلفة خدمة النقل؟",
    answer: (
      <p>
  ...
  {
    question: "هل تتوفر لديكم خدمة نقل أثاث مستعجلة في نفس اليوم؟",
    answer: (
      <p>
...
export const ArAjmanMoversFaqs: {
  question: string;
  answer: React.ReactNode;
}[] = [
  {
    question: "كم تكلفة نقل الأثاث داخل عجمان؟",
    answer: (
      <p>
  ...
  {
    question: "كيف أختار أفضل شركة نقل أثاث في عجمان؟",
    answer: (
      <p>
  ...
  {
    question: "هل تقدمون خدمة فك وتغليف وتركيب الأثاث الشاملة؟",
    answer: (
      <p>
  ...
  {
    question: "هل يمكن حجز خدمة نقل الأثاث في نفس اليوم؟",
    answer: (
      <p>
  ...
  {
    question: "هل تتوفر لديكم خدمة تخزين الأثاث في عجمان؟",
    answer: (
      <p>
  ...
  {
    question: "هل يشمل عرض السعر مواد التغليف؟",
    answer: (
      <p>
  ...
  {
    question: "ما الفرق بين النقل بشاحنة مغلقة وشاحنة مفتوحة؟",
    answer: (
      <p>
  ...
  {
    question: "هل يتم تقديم ضمان أو تأمين على المنقولات؟",
    answer: (
      <p>
