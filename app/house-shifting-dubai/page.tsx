...
import { ChevronRight, Headset, MapPinCheck, PhoneCall } from "lucide-react";
    ...
    <main>
      ...
      <div className="max-w-7xl md:px-10 mx-auto mt-32 grid lg:grid-cols-6 grid-col-1 min-h-screen gap-10">
        ...
        >
          <section>
            <h3>
              Dubai&apos;s Most Experienced House Movers — 25+ Years, Thousands
              of Moves, Zero Hidden Charges
            </h3>
            <p>
          ...
          <section className="grid lg:grid-col-3 md:grid-cols-2 grid-cols-1 gap-5">
            <div>
              ...
              <p className="-mt-2">
                Registered in 1998, we have completed thousands of house shifts
                across Dubai and all UAE emirates. That track record matters
                when you are trusting someone with your home.
              </p>
            </div>
            <div>
              <h3>Licensed & Legally Registered: </h3>
              <p className="-mt-2">
                Unlike freelance movers, we are a fully licensed company with a
                verified Google Business Profile. You know exactly who you are
                dealing with.
              </p>
            </div>
            <div>
              ...
              <p className="-mt-2">
                The quote you receive is the exact amount you pay. No surprises
                on moving day, no last-minute additions.
              </p>
            </div>
            <div>
            ...
            <div>
              ...
              <p className="-mt-2">
                ...
                emergency relocations across Dubai. Call us directly for fastest
                response.
              </p>
            </div>
            <div>
              ...
              <p className="-mt-2">
                ...
                Dubai&apos;s 45°C+ heat and sandstorms. Open pickups are a risk
                we never take with your belongings.
              </p>
            </div>
          </section>
          ...
          <section>
            ...
            <p>
              From small studio moves to large villa relocations, we cover every
              type of residential move across Dubai. Each service below is
              handled by a trained crew — not subcontractors, not day labour.
            </p>
          ...
          <section>
            ...
            <p>
              ...
              shortcuts, no skipped steps. Here is what happens from the moment
              you contact us to the moment you are settled in your new home.
            </p>
          ...
          <section>
            ...
            <p>
              We believe in fixed, honest pricing. The number we give you before
              the move is the number you pay on the day — no additions, no
              surprises.{" "}
            </p>
            <p className="mb-10">
              ...
              {pricingData.map((item, index) => (
                ...
                >
                  ...
                  <div className="flex justify-between py-2 border-t border-gray-100">
                    ...
                    <span className="text-sm text-gray-600">{item.truck}</span>
                  </div>
                </div>
              ))}
            </div>
            <p className="mt-5">
              Final pricing depends on move size, distance, floor level, and any
              additional services selected. Contact us for your customised
          ...
          <section>
            ...
            <p>
              ...
              operate UAE-wide. Whether you are moving within the same community
              or relocating from Dubai to another emirate, we handle it.
            </p>
            <p className="mt-2 mb-5">
              <b>Dubai Areas:</b> Downtown Dubai, Dubai Marina, Business Bay,
              Palm Jumeirah, Jumeirah Village Circle (JVC), Al Barsha, Deira,
              Bur Dubai, Al Quoz, International City, Discovery Gardens, and all
          ...
          <section>
            ...
            <p>
              Unlike freelance movers with no accountability, we are a licensed
              company — which means if anything ever goes wrong, you have proper
              recourse. No legitimate moving company should be operating without
              a trade licence. We are not a risk worth taking.
            </p>
