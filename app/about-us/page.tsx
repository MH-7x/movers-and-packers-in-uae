    ...
    <main>
            ...
            <div className="flex flex-col md:flex-row gap-3">
              ...
              <div className="flex-1 flex flex-col">
                ...
                <p className="text-muted-foreground text-[15px] leading-[1.8] mb-12 pr-4 lg:pr-10">
                  ...
                  is over 25 years in the same business, doing the same job, for
                  real people with real belongings.
                </p>
      ...
      <section className="max-w-7xl mx-auto md:px-10 px-4 mt-32 grid md:grid-cols-2 grid-col-1 items-center md:gap-20">
        ...
        <div className="md:order-2 order-1">
          ...
          <p className="mt-2 text-muted-foreground">
            If you want to know who is coming into your home or office to handle
            your move, you can check our Google Business Profile, meet the
            owner, or simply call us and ask anything.
          </p>
      ...
      <section className="max-w-6xl mx-auto md:px-10 px-4 mt-20 p-16 bg-foreground rounded-3xl">
        ...
        <p className="mt-10 text-lg text-white/80">
          ...
          movers you see on WhatsApp today did not even exist. The owner started
          with a small team and a clear idea: move people&apos;s things
          carefully, charge fairly, and show up when promised.
        </p>
        <div className="grid md:grid-cols-2 gird-cols-1 gap-5 md:mt-10 mt-5 text-white/80">
          <p>
            ...
            Fujairah, Khor Fakkan, and Al Ruwais. The work is the same: pick up,
            pack, move, deliver — but done right.
          </p>
          <p className="md:border-l md:border-t-transparent border-t md:pl-5 md:pt-0 pt-5">
            ...
            belongings and privacy while we are inside your space. Those are not
            just words on a website — they are what we think about every time we
            send a team into someone&apos;s home.
          </p>
        </div>
      </section>
      ...
      >
        ...
        <div className="md:pt-10 text-muted-foreground md:text-lg">
          ...
          <p className=" mt-2">
            You describe your move. We send you a detailed quote on WhatsApp and
            email with everything written clearly. No hidden charges. If the
            quote says 1,000 AED, that is what you pay. Not a dirham more.
          </p>
          <p className=" mt-2">
            We also offer same-day service. If you just arrived in the UAE or
            your move is urgent, call us and we will work out the fastest option
            available.
          </p>
          <p className=" mt-2">
      ...
      <section className="max-w-4xl mx-auto md:px-10 px-4 mt-32">
        ...
        <div className="mt-5 md:text-lg text-muted-foreground flex flex-col gap-y-2 text-center">
          <p className="">
            ...
            handling. They speak English and Arabic, so communication on the day
            of the move is not a problem.
          </p>
          <p>
            ...
            requires trust. That is why we take vetting seriously and have kept
            the same professional standards since the company started.
          </p>
      ...
      <section className="max-w-4xl mx-auto md:px-10 px-4 mt-20">
        ...
        <div className="mt-5 md:text-lg text-muted-foreground flex flex-col gap-y-2 text-center">
          <p className="">
            ...
            WhatsApp and random websites. Most of them have no licence, no fixed
            address, and no accountability. If something goes wrong, they are
            gone.
          </p>
          <p>
            We are different not because we say so, but because we have a paper
            trail.
          </p>
          <p>
