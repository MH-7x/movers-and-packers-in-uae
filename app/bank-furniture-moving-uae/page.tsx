  ...
  return (
    <main>
      ...
      <section className="mt-16 max-w-4xl mx-auto md:px-0 px-4">
        <div className="md:text-lg text-muted-foreground text-center mt-10 md:px-20 space-y-4">
          <p>
            ...
            core philosophy our company has operated on since 1998.
          </p>
          <p>
            If you are a bank manager, facilities director, or IT infrastructure
            head planning a branch relocation, fit-out change, or full bank
            office move anywhere in UAE, our team is the professionally
            licensed, commercially experienced partner you need.
          </p>
          <p>
            {" "}
            We have handled complex commercial furniture moves across Dubai, Abu
            Dhabi, Sharjah, and all UAE emirates.
          </p>
      ...
      <QuotationSection
        title={
          <>
            <span className="font-bold md:block">Get a Confidential Quote</span>{" "}
        ...
        >
          <section>
            ...
            <ul className="list-inside list-disc mt-6 text-muted-foreground leading-relaxed space-y-2">
              <li>
                Security sensitivity: bank counters, teller stations, and vault
                rooms hold or have held high-value assets — discretion is
                essential
              </li>
              <li>
              ...
              <li>
                Privacy of client data — no unauthorized personnel should access
                back-office areas
              </li>
            </ul>
            <p className="mt-6">
              Our company was built on the principles of Protection and Privacy.
              Every team member is vetted, trained in professional handling, and
              understands the confidentiality requirements of moving commercial
          ...
          <section>
            ...
            <div className="flex flex-col gap-y-3 text-muted-foreground">
              <p>
                ...
                commercial environments for 25+ years. We understand that a bank
                relocation is not just about moving furniture — it is about
                maintaining security, ensuring privacy, and minimizing
                operational disruption.
              </p>
              <p>
                Our team is hand-picked, thoroughly vetted, and trained
                specifically for commercial and financial institution moves. We
                follow strict protocols that ensure all sensitive items and
                areas are handled with the utmost professionalism.
              </p>
              <p>
                From the initial confidential consultation through to final
                sign-off, we work exclusively under your supervision and follow
                all your security access guidelines. Your requirements shape our
          ...
          <div className="w-full mt-5 relative overflow-hidden aspect-square">
            ...
            <div className="absolute inset-0 w-full h-full bg-primary/75 flex items-center justify-center flex-col gap-y-3 p-5">
              ...
              <h3 className="mt-5 text-2xl uppercase font-bold text-white text-shadow-2xs text-center">
                Plan Your Bank Relocation Today
              </h3>
