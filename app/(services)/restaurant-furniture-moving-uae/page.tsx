      ...
      <main>
        ...
        <section className="mt-16 max-w-4xl mx-auto md:px-0 px-4">
          ...
          <div className="md:text-lg text-muted-foreground text-center mt-10 md:px-20">
            ...
            <p>
              Since 1998, we have been the trusted commercial furniture movers
              for businesses across UAE including restaurants, cafes, cloud
              kitchens, hotel F&B outlets, and catering businesses in Dubai, Abu
              Dhabi, Sharjah, and all UAE emirates. Our experience means we
              understand the urgency of your relocation and plan every move to
        ...
        <div className="max-w-7xl md:px-10 mx-auto mt-20 grid lg:grid-cols-6 grid-col-1 min-h-screen gap-10">
          ...
          >
            <section>
              <h2>
                Why Restaurant Furniture Moving Requires Specialist Movers
              </h2>
              ...
              <ul className="mt-5 space-y-3 list-disc list-inside text-muted-foreground">
                ...
                <li>
                  ...
                  — industrial ovens, refrigeration units, prep tables,
                  extraction systems
                </li>
                <li>
                  <span className="font-semibold text-foreground">
