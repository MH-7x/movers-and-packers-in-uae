    ...
    <main>
      ...
      <section className="mt-16 max-w-4xl mx-auto md:px-0 px-4">
        <p className="md:text-xl text-lg font-bold text-center">
          ...
          face a unique challenge when relocating or rearranging furniture: the
          moves must be efficient, complete, and disruptive-free — ideally timed
          with term breaks or non-teaching periods.
        </p>
        <div className="md:text-lg text-muted-foreground text-center mt-10 md:px-20">
          ...
          <p>
            With over 25 years of institutional and commercial moving experience
            since 1998, we understand the scale and coordination required to
            move a school campus, relocate classroom furniture, or shift an
            entire administration block quickly and safely.
          </p>
        </div>
      ...
      <div className="max-w-7xl md:px-10 mx-auto mt-20 grid lg:grid-cols-6 grid-col-1 min-h-screen gap-10">
        ...
        >
          <section>
            ...
            <p>
              Educational furniture relocation is more complex than it appears:
            </p>
            <ul className="mt-5 space-y-3 list-disc list-inside text-muted-foreground">
              <li>
                <span className="font-semibold text-foreground">Volume:</span> A
                school may have hundreds of desks, chairs, and storage units
                across dozens of classrooms
              </li>
              <li>
                <span className="font-semibold text-foreground">Variety:</span>{" "}
                Classrooms, libraries, science labs, IT suites, sports storage,
                canteens, and admin offices all have different furniture types
              </li>
              <li>
              ...
              <li>
                ...
                Items must be systematically labelled by room number so they can
                be set up correctly at the destination
              </li>
              <li>
                <span className="font-semibold text-foreground">Safety:</span>{" "}
                Student safety areas must not be blocked during the move process
              </li>
            </ul>
          </section>
