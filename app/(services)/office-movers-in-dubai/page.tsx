          ...
          >
            <section>
              <h2>
                ...
                <br className="md:block hidden" /> for Office Relocation Dubai
              </h2>
              <p>
                There&apos;s no shortage of{" "}
                <Link href="/">moving companies in Dubai</Link>. But most of
                them are freelance operators — no legal permit, no
                accountability, no protection for your valuables. We&apos;re
                different.
              </p>
              <p className="mt-2">
                We&apos;ve been legally registered and operating since 1998. You
                can check us on Google Maps, meet the owner, and verify
                everything before you commit. That&apos;s the level of trust
                we&apos;ve built over 25+ years of commercial moving across the
                UAE.
              </p>
              ...
              <div className="mt-10 grid md:grid-cols-2 grid-cols-1 gap-10">
                {[
                  ...
                  },
                  {
                    ...
                    href: "/packing-services-in-dubai#office-and-commercial-packing-services",
                  },
                  {
            ...
            <section>
              ...
              <p>
                ...
                don&apos;t. Different businesses have different requirements,
                and we&apos;ve built experience across all of them.
              </p>
              <div className="grid md:grid-cols-3 grid-cols-1 gap-3 mt-3 leading-tight text-sm">
                ...
                <div className="bg-secondary py-3 px-4 rounded-2xl">
                  ...
                  <p>
                    Medical equipment, diagnostic tools, patient record
                    transfers, hygiene protocols
                  </p>
                </div>
                <div className="bg-secondary py-3 px-4 rounded-2xl">
                  <h3 className="text-base! mb-1! font-medium!">
              ...
              <p className="mt-4">
                If your business type isn&apos;t listed above, contact us
                anyway. We offer customized moving plans for any commercial
                setup.
              </p>
            </section>
              ...
              <div className="mt-10 grid md:grid-cols-2 grid-cols-1 gap-5">
                <div>
                  ...
                  <p className=" mt-3 text-muted-foreground leading-tight">
                    ...
                    Marina | Al Quoz | Downtown Dubai | Deira | Bur Dubai |
                ...
                <div>
                  ...
                  <p className=" mt-3 text-muted-foreground leading-tight">
                    Abu Dhabi | Sharjah | Ajman | Ras Al Khaimah | Al Ain | Umm
                    Al Quwain | Fujairah | Al Ruwais | Khor Fakkan.
                    <br />
                    Inter-emirate office relocation is handled with the same
                    fixed-quote system — no surprise distance surcharges added
                    at the end.
                  </p>
                </div>
              </div>
            ...
            <section>
              ...
              <p>
                Cash | Online Transfer | Bank Cheque — paid after job
            ...
            <section>
              ...
              <ul className="grid md:grid-cols-3 grid-cols-1 gap-3 mt-3">
                ...
                <li className="bg-secondary py-2 px-3 rounded-2xl leading-tight">
                  <span className="font-medium">Distance —</span> within Dubai,
                  or inter-emirate
                </li>
                <li className="bg-secondary py-2 px-3 rounded-2xl leading-tight">
                ...
                <li className="bg-secondary py-2 px-3 rounded-2xl leading-tight">
                  ...
                  elevator bookings, moving permits, loading bay arrangements
                </li>
              </ul>
            ...
            <section>
              ...
              <ol className=" list-inside text-muted-foreground leading-tight mt-5">
                <li>
                  <b>Step 1 — Contact Us:</b> Call, WhatsApp, or fill in the
                  quote form on this page. Tell us your office size, what needs
                  moving, and your preferred date. That&apos;s it.
                </li>
                <li>
                ...
                <li>
                  ...
                  agreed date and manages the entire office relocation —
                  packing, dismantling, transport, unloading, and setup. You
                  focus on your business. We focus on your move.
                </li>
              </ol>
              <p className="mt-5">
                Most quotes are delivered within a few hours of your enquiry.
                For urgent same-day office moves, contact us directly by phone
                or WhatsApp.
              </p>
            </section>
          </div>
