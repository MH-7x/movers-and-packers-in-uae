    ...
    <main>
      <LocHeroSection
        ...
        desc={
          <>
            ...
            <p>
              We are one of the few movers and packers in Fujairah with over 25
              years of documented experience — thousands of successful moves
              completed, and a company that was registered long before most
              freelance operators even started.
            </p>
          </>
        }
      ...
      <section className="mt-20 max-w-4xl mx-auto md:px-0 px-4">
        <p className="md:text-2xl text-xl font-bold text-center">
          ...
          single piece of furniture, our trained team handles the entire process
          for you.
        </p>
        <p className="text-center mt-5 text-muted-foreground">
          Packing, loading, transport, and setup — all done properly. Get a free
          quote today by calling us or sending a WhatsApp message. We respond
          within minutes.
        </p>
      </section>
          ...
          {[
              ...
              description: (
                <>
                  <p>
                    ...
                    single sofa, wardrobe, heavy safe, or any standalone piece,
                    we handle single-item moves too. Our carpenters can
            ...
            },
            {
              ...
              description: (
                <>
                  <p>
                    We use proper packing materials — bubble wrap, stretch film,
                    carton boxes, fabric blankets, and corrugated rolls. Every
                    box is labelled by room, so unpacking is organised and fast.
                  </p>
                </>
              ),
              extra: (
              ...
              description: (
                <>
                  <p>
                    ...
                    offer short-term and long-term storage in Fujairah — secure
                    warehousing for furniture, household items, and commercial
                    goods.
                  </p>
                </>
              ),
      ...
      <section className="mt-20 max-w-7xl md:px-10 px-4 mx-auto">
        ...
        <p className="text-muted-foreground mt-5 text-center">
          Our movers cover the entire emirate of Fujairah. From the city centre
          to the outskirts near the Hajar Mountains, and all the way along the
          Gulf of Oman coastline — we reach you. Here are the main areas we
          serve:
        </p>
        ...
        <p className="text-muted-foreground mt-5 text-center max-w-4xl mx-auto">
          ...
          emirate, we cover those routes regularly. Just let us know your start
          and end points and we will give you a clear quote.
        </p>
      </section>
          ...
          <div className="p-6 sm:p-12 border-b md:border-b-0 md:border-r border-slate-100 bg-red-50/50 ">
            ...
            <div className="space-y-2 text-slate-600 leading-relaxed">
              <p>
                ...
                electronics travel in an open truck during these conditions, the
                risk of damage is real — not theoretical.
              </p>
              <p>
                Our fully enclosed, RTA-approved box trucks seal your belongings
                away from heat, dust, and sand throughout the entire journey.
              </p>
              <p>
          ...
          <div className="p-6 sm:p-12 hover:bg-slate-50/50 transition-colors duration-300">
            ...
            <div className="space-y-2 text-slate-600 leading-relaxed">
              <p>
                ...
                are a practical and cost-effective choice. Loading and unloading
                is quicker.
              </p>
              <p>
                If you are moving a small number of items on a clear day and
                cost is the priority, this works fine. Our team will always
                advise you honestly on which truck is right for your situation.
              </p>
              <p>
                We also carry all necessary equipment on-site: hydraulic lifts,
                heavy-duty dollies, and full carpentry tools for furniture
              ...
              {[
                ...
                <li key={idx} className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-slate-500 mt-1">{factor.desc}</p>
                  </div>
                </li>
              ))}
            </ul>
      ...
      <section className="max-w-4xl mx-auto mt-10 md:px-0 px-4 flex flex-col gap-y-5">
        <div>
          ...
          <p className="text-muted-foreground mt-3">
            ...
            apartments, offices, and specialist commercial jobs. We built the
            company on two principles: Protection and Privacy. Every item we
            move is treated with care. Every home and office we enter is treated
            with respect.
          </p>
          <p className="text-muted-foreground mt-3">
            We have a verified Google Business Profile, a bilingual team, and an
            owner who has been in this industry since before most of the current
            competition existed. If you want to speak with someone before
            booking, just call. We are straightforward people who do good work.
          </p>
