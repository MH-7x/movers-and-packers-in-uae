    ...
    <main>
      <LocHeroSection
        h1={
          <>
            ...
            <span className="font-normal">Trusted RAK Movers and Packers</span>
          </>
        }
        desc={
          <>
            <p>
              If you need movers in Ras Al Khaimah, the first thing you want to
              know is whether the company is legitimate — not a freelancer
      ...
      <section className="mt-20 max-w-4xl mx-auto md:px-0 px-4">
        ...
        <p className="text-center mt-5 text-muted-foreground">
          ...
          you pay only after the move is complete and you are satisfied. That is
          how we have worked for over 25 years.
        </p>
      </section>
      <QuotationSection
        title={
          ...
          {[
              ...
              extra: (
                <>
                  ...
                  <p>
                    ...
                    45°C. An open flatbed truck exposes mattresses, sofas, and
                    electronics to direct heat during the drive.
                  </p>
                  <p>
                    Our trucks are fully sealed, so your items travel protected
                    from heat and dust regardless of the season.
                  </p>
                </>
              ),
              img: {
              ...
              extra: (
                <>
                  ...
                  <p>
                    ...
                    details on WhatsApp and we will give you a quote the same
                    day.
                  </p>
                </>
              ),
              ...
              description: (
                <>
                  <p>
                    ...
                    stretch film, protective pads, clothing boxes, and separate
                    packaging for kitchen items and fragile goods.
                  </p>
                </>
              ),
              extra: (
            ...
            },
            {
              ...
              description: (
                <>
                  <p>
                    Not every move goes directly from one address to another. If
                    you are between tenancies, going through a renovation, or
                    need temporary storage for furniture, we have you covered.
                  </p>
                </>
              ),
              extra: (
                <>
                  <p>
                    Our storage service in Ras Al Khaimah is available for both
            ...
            },
            {
              ...
              description: (
                <>
                  <p>
                    Once the move is finished, there is still the job of setting
                    up the new place. Our team can install curtains and curtain
                    rods the same day as your move.
                  </p>
                </>
              ),
              extra: (
                <>
                  <p>
                    ...
                    after you have already been through a move. It is a service
                    most moving companies in RAK do not offer.
                  </p>
                  <p>
                    Ask about it when you get in touch and we will include it in
                    your quote.
                  </p>
                </>
              ),
      ...
      <section className="max-w-7xl w-full mx-auto mt-20 md:px-20 px-4">
        ...
        <div className=" pb-8  border-b border-gray-50">
          ...
          <p className=" text-muted-foreground max-w-3xl">
            We do not publish fixed prices because no two moves are the same. A
            studio apartment in Al Nakheel and a 5-bedroom villa in Al Hamra
        ...
        <div className="grid md:grid-cols-3 lg:grid-cols-4 grid-cols-1 gap-10 mt-10">
          {[
            ...
            },
            {
              ...
              description: "Corporate office relocation with minimal downtime",
            },
            {
            ...
            },
            {
              ...
              description: "Long-distance residential or commercial relocation",
            },
          ].map((feature, i) => (
      ...
      <section className="max-w-7xl mx-auto mt-20 md:px-10 px-4">
        ...
        <div className="grid md:grid-cols-3 lg:grid-cols-4 grid-cols-1 gap-10 mt-10">
          {[
            ...
            {
              title: "Khuzam",
              description: "Mixed residential — furniture and apartment moves",
            },
            {
              title: "Al Qusaidat",
              description:
