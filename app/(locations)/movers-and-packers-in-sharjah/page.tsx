    ...
    <main>
      ...
      >
        ...
        <p className="mt-5 text-muted-foreground text-center max-w-4xl mx-auto">
          There are plenty of moving companies in Sharjah. Some are registered,
          most are not. And if you’ve hired a freelance mover before, you
          probably already know how that can go — vague pricing, rough handling,
          no accountability.
        </p>
        ...
        <div className="mt-10 grid lg:grid-cols-4 md:grid-cols-3 grid-cols-1 gap-5">
          {[
            ...
            <div className="border-b border-primary pb-3" key={index}>
              ...
              <p className="text-muted-foreground leading-tight">{item.desc}</p>
            </div>
          ))}
        </div>
        <p className="mt-5 text-muted-foreground text-center max-w-4xl mx-auto">
          We’re not trying to win your trust with big promises. We’re a legal,
          registered company with a real owner, a real address, and thousands of
          completed moves behind us. That’s the difference.
        </p>
      </section>
      <section
      ...
      >
        <div className="bg-foreground rounded-2xl md:p-10 px-4 py-10 grid md:grid-cols-2 grid-cols-1 md:gap-10 gap-8">
          <div>
            ...
            <h2 className="md:text-4xl text-3xl text-white mt-3">
              Our Moving <span className="font-bold">Services in Sharjah</span>{" "}
        ...
        <div className="mt-16 grid md:grid-cols-2 grid-cols-1 gap-10">
          ...
          <div className="bg-white drop-shadow-lg md:p-6 px-4 py-6 rounded-3xl">
            ...
            <div className="mt-3 text-muted-foreground flex gap-y-1.5 leading-tight flex-col">
              <p>
                ...
                equipment to worry about, data to protect, and you usually can’t
                afford to be shut down for long.
              </p>
              <p>
              ...
              <p>
                We also understand that commercial moves require a higher level
                of trust. That’s why we encourage you to check our Google
                Business Profile before you hire us, and to speak directly with
          ...
          <div className="bg-white drop-shadow-lg md:p-6 px-4 py-6 rounded-3xl">
            ...
            <div className="mt-3 text-muted-foreground flex gap-y-1.5 leading-tight flex-col">
              <p>
                Not every move is a whole house. Sometimes you just need to move
                a sofa, a wardrobe, or a single bed to a new flat. We do that
                too.
              </p>
              <p>
                Our furniture movers in Sharjah handle single-item moves just as
                professionally as full relocations. And if you’re moving
          ...
          <div className="bg-white drop-shadow-lg md:p-6 px-4 py-6 rounded-3xl">
            ...
            <div className="mt-3 text-muted-foreground flex gap-y-1.5 leading-tight flex-col">
              <p>
                ...
                bubble wrap for electronics and fragile items, and stretch film
                for furniture.
              </p>
              <p>
          ...
          <div className="bg-white drop-shadow-lg md:p-6 px-4 py-6 rounded-3xl">
            ...
            <div className="mt-3 text-muted-foreground flex gap-y-1.5 leading-tight flex-col">
              <p>
                Sometimes the timing doesn’t work perfectly — your move-out date
                arrives before you can get into the new place. We offer
            ...
            <div>
              ...
              <div className="mt-3 text-muted-foreground flex gap-y-1.5 leading-tight flex-col">
                <p>
                  ...
                  your plans suddenly change and you need to relocate tomorrow?
                  Call us.
                </p>
                <p>
                ...
                <p>
                  A single WhatsApp message is enough to get the process started
                  — describe your situation and we’ll tell you honestly what we
                  can do.
                </p>
              </div>
              <Button quoteBtn className="mt-5">
      ...
      <section className="mt-20 max-w-7xl md:px-10 px-4 mx-auto">
        ...
        <p className="text-muted-foreground mt-5 text-center max-w-4xl mx-auto">
          We also handle inter-emirate moves — from Sharjah to Dubai, Abu Dhabi,
          Ajman, Ras Al Khaimah, and beyond. Distance isn’t a problem. Just tell
          us where you’re going and we’ll plan accordingly.
        </p>
      </section>
      <MovingProcess
        title={
      ...
      >
        <div className=" md:order-1 order-2 md:text-lg text-muted-foreground mt-5 leading-tight">
          ...
          <p className="mt-1.5">
            We send every quote in writing to your WhatsApp or email so you have
            it in black and white before you commit to anything.
          </p>
          <p className="mt-1.5">
            For affordable movers in Sharjah, we offer competitive rates without
            cutting corners on service or insurance. And if you’re working with
            a tight timeline and need a budget-friendly option, contact us —
          ...
          <p className="mt-1.5">
            We don’t ask for deposits before starting work. You pay when the job
            is done.
          </p>
          <p className="mt-1.5">
        ...
        <div className="md:order-2 order-1">
          ...
          <h2 className="md:text-4xl text-3xl font-bold mt-3 ">
            {" "}
            <span className="md:block font-normal">Movers in Sharjah</span>{" "}
      ...
      <section className="max-w-6xl mx-auto px-4 md:px-10 mt-32">
        ...
        <article className="mt-12 md:mt-16 text-center max-w-4xl mx-auto bg-white p-6 md:p-8 rounded-2xl border border-slate-100 shadow-sm">
          <p className="text-base md:text-lg text-slate-700 leading-relaxed font-medium">
            ...
            <span className="text-primary font-bold">since 1998</span>. Most of
            the freelance movers that operate in Sharjah today didn’t exist back
            then. That track record means something when you’re handing over
            your furniture, your personal items, and access to your home.
          </p>
        </article>
      </section>
      <section className="max-w-6xl mx-auto px-4 md:px-10 mt-20">
        ...
        <div className="text-center max-w-3xl mx-auto mb-12 md:mb-16">
          ...
          <p className="text-lg text-muted-foreground ">
            ...
            international move. We work with cargo and freight partners for sea,
      ...
      <div className="max-w-4xl mx-auto md:px-0 px-4 mt-10 md:text-xl text-lg font-medium text-center">
        ...
        <p className="mt-2 mb-5">
          25 years in this business has taught us one thing: a straightforward,
