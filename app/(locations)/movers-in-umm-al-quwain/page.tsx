    ...
    <main>
      <LocHeroSection
        ...
        desc={
          <>
            <p>
              Finding good movers in Umm Al Quwain is harder than it should be.
              You search online, get a few numbers, and half of them turn out to
              be freelancers with no license, no real truck, and no
              accountability. If something breaks or goes missing, there&apos;s
              nobody to call back.
            </p>
            <p>
      ...
      <section className="mt-20 max-w-4xl mx-auto md:px-0 px-4">
        <p className="md:text-2xl text-xl font-bold text-center">
          ...
          across UAQ, using RTA-approved trucks, professional packing materials,
          and a price that doesn&apos;t change after we quote it.
        </p>
      ...
      <section className="max-w-5xl mx-auto mt-20 md:px-0 px-4 gap-5 grid md:grid-cols-2 grid-cols-1">
        <div className="col-span-full max-w-3xl mb-10">
          ...
          <p className="text-muted-foreground mt-3">
            There are plenty of moving options in UAQ. Here&apos;s what actually
            separates us from the rest — and why customers who do their research
            tend to come back to us.
          </p>
        </div>
        <div>
          ...
          <div className="text-muted-foreground flex flex-col gap-y-1 mt-2">
            <p>
              We started in 1998. Most of the freelance movers you&apos;ll find
              online didn&apos;t exist then. Our team has completed thousands of
              moves across all Emirates — homes, offices, warehouses, clinics,
        ...
        <div>
          ...
          <div className="text-muted-foreground flex flex-col gap-y-1 mt-2">
            <p>
              We quote you AED 1,000, you pay AED 1,000. No fuel surcharge added
              at the end. No extra packing fee added later that was never
              mentioned. No surprise floor-access cost on moving day.
            </p>
            <p>
        ...
        <div className="col-span-full">
          ...
          <div className="text-muted-foreground flex flex-col gap-y-1 mt-2">
            <p>
              ...
              4-ton, RTA-approved) and open trucks, all regularly maintained and
              clean.
            </p>
            ...
            <p>
              ...
              cost-effective option. We&apos;ll recommend the right one for your
              specific move.
            </p>
          </div>
        </div>
        <div>
          ...
          <div className="text-muted-foreground flex flex-col gap-y-1 mt-2">
            ...
            <p>
              ...
              hiring a freelancer with a pickup truck. One has something to lose
              if the job goes badly. The other doesn&apos;t.
            </p>
          </div>
        </div>
        <div>
        ...
        <div>
          ...
          <div className="text-muted-foreground flex flex-col gap-y-1 mt-2">
            <p>
              ...
              heavy items safely, wrap fragile pieces correctly, and reassemble
              furniture without stripping screws or splitting panels.
            </p>
        ...
        <div>
          ...
          <div className="text-muted-foreground flex flex-col gap-y-1 mt-2">
            <p>
              Letting strangers into your home to pack your bedroom and kitchen
              is not a small thing. You&apos;re trusting us with spaces that
              matter.
            </p>
      ...
      <MovingProcess
        title={
          <>
            ...
            <span className="md:block font-normal">Works in Umm Al Quwain</span>
          </>
        }
      ...
      <section className="mt-20 max-w-7xl md:px-10 px-4 mx-auto">
        ...
        <p className="text-muted-foreground mt-3 text-center max-w-2xl mx-auto">
          ...
          familiar with access routes, building regulations, and local logistics
          across all major areas of the emirate, including:
        </p>
        ...
        <p className="text-muted-foreground mt-3 text-center max-w-3xl mx-auto">
          ...
          relocations with the same process and the same pricing transparency as
          local UAQ moves.
        </p>
        <p className="text-muted-foreground mt-3 text-center max-w-3xl mx-auto">
          We regularly move between Umm Al Quwain and Dubai, Sharjah, Ajman, Ras
          Al Khaimah, Al Ain, Abu Dhabi, Fujairah, and Khor Fakkan.
        </p>
        <p className="text-muted-foreground mt-3 text-center max-w-3xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 bg-foreground text-white">
          <div className="lg:col-span-3 p-8 md:p-12 flex flex-col justify-center">
            ...
            <p className="text-white/80 text-lg leading-relaxed max-w-2xl">
              We don&apos;t publish fixed rates because every move is different.
              A studio apartment and a five-bedroom villa are not the same job,
              and quoting both at the same price would be misleading.
            </p>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 p-8 md:p-12">
          ...
          <div>
            ...
            <div className="space-y-5 text-slate-600">
              ...
              <p>
                If you&apos;re comparing our quote to a cheaper one from another
                company, check what&apos;s included. Does their price cover
                packing materials? Furniture dismantling and reassembly? A
                covered, RTA-approved truck?{" "}
