    ...
    <main>
      <LocHeroSection
        ...
        desc={
          <>
            <p>
              Looking for reliable movers in Ajman? You are in the right place.
              We are a fully licensed and registered moving company that has
              been operating since 1998 — with thousands of completed moves
              across the UAE.
            </p>
            <p>
              Whether you need to shift a studio apartment, a large villa, or a
              commercial office, our movers and packers in Ajman handle
      ...
      <section className="max-w-7xl mx-auto mt-32 md:px-10 px-4">
        ...
        <div className="text-center mb-10 max-w-4xl mx-auto">
          ...
          <p className="text-muted-foreground">
            ...
            Ajman since 1998 — with a verified Google Business profile, an
          ...
          {[
            {
              ...
              extra: (
                <>
                  ...
                  <p>
                    That is exactly why our company operates on a philosophy of
                    protection and privacy — your belongings and your space are
              ...
              description: (
                <>
                  ...
                  <p>
                    ...
                    glass items, and full kitchen setups.
                  </p>
                </>
              ),
              extra: (
            ...
            },
            {
              ...
              description: (
                <>
                  <p>
                    ...
                    need to move specific pieces — a sofa, a bed, a wardrobe, or
                    a dining set.
                  </p>
                  <p>
              ...
              extra: (
                <>
                  <p>
                    If the furniture needs dismantling before it can safely pass
                    through a doorway or elevator, our carpenters handle that
            ...
            },
            {
              ...
              extra: (
                <>
                  <p>
                    We label everything clearly so setup at the new location is
                    straightforward.
                  </p>
                  <p>
            ...
            },
            {
              ...
              description: (
                <>
                  <p>
                    Need somewhere to keep your belongings during a renovation,
                    a delayed move-in, or a transition period? We offer secure
                    storage in Ajman for both short-term and long-term needs.
                  </p>
                  <p>
            ...
            },
            {
              ...
              extra: (
                <>
                  <p>
                    {" "}
                    If you own or manage a commercial space in Ajman and need a
                    professional team to handle your relocation, contact us to
                    discuss the scope and get a quote.
                  </p>
                </>
              ),
              ...
              description: (
                <>
                  <p>
                    ...
                    destinations: Dubai, Sharjah, Abu Dhabi, Ras Al Khaimah, Al
                    Ain, Fujairah, and Umm Al Quwain.
                  </p>
                  <p>
      ...
      >
        ...
        <p className="mt-2 text-muted-foreground max-w-3xl mx-auto text-center">
          Contact us with your details and we will send a clear, itemized quote
          — no surprises. And as we have said before: whatever the quote says is
          what you pay. That is a firm policy.
        </p>
      </section>
      <MovingProcess />
      <section className="max-w-4xl mx-auto mt-20 md:px-0 px-4 flex flex-col gap-y-5">
        <div>
          ...
          <p className="text-muted-foreground mt-3">
            ...
            informal day workers to save money. Here is what that usually means
            in practice.
          </p>
        </div>
        <div>
          ...
          <div className="text-muted-foreground flex flex-col gap-y-1 mt-2">
            <p>
              Renting a truck, buying packing materials, paying for helpers, and
              spending your own time and energy — it adds up fast.
            </p>
            <p>
        ...
        <div>
          ...
          <div className="text-muted-foreground flex flex-col gap-y-1 mt-2">
            <p>
              ...
              something is damaged or missing after the move, you have no legal
              recourse. For a residential move that is already a risk.
            </p>
            <p>
        ...
        <div>
          ...
          <div className="text-muted-foreground flex flex-col gap-y-1 mt-2">
            ...
            <ul className="list-inside list-disc">
              ...
              <li>
                Do they provide a written quote — via WhatsApp or email — before
                the move starts?
              </li>
        ...
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
          ...
          <div className="relative overflow-hidden rounded-2xl p-6 ">
            ...
            <p className="text-sm text-muted-foreground">
              ...
              schedule it early in the morning before 9 AM or after sunset when
              temperatures come down. Our enclosed trucks help, but limiting
              direct exposure time still matters.
            </p>
          </div>
