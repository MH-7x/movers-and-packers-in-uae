      ...
      <main>
        ...
        >
          <div className=" md:order-1 order-2 md:text-lg text-muted-foreground mt-5 leading-tight">
            <p>
              ...
              market is full of operators — many with no physical office, no
              trade licence, and no accountability once your furniture is on
              their truck. We are different.
            </p>
            <p className="mt-2">
              As a DED-registered{" "}
              <Link href="/">shifting company in Dubai</Link>, operating since
              1998, we have handled thousands of residential and commercial
              moves across the city — from Deira to Dubai Marina, Bur Dubai to
              Dubai Silicon Oasis.
            </p>
            <p className="mt-2">
        ...
        <section className="max-w-7xl mx-auto mt-20 md:px-10 px-4">
          ...
          <div className="text-center mb-10 max-w-4xl mx-auto">
            ...
            <p className="text-muted-foreground">
              There are a number of moving companies in dubai. Here is what
            ...
            {[
                ...
                description: (
                  <>
                    <p>
                      ...
                      floors, outdoor items, and often high-value pieces that
              ...
              },
              {
                ...
                description: (
                  <>
                    <p>
                      Whether you are in a studio in Bur Dubai or a 3BHK in
                      Dubai Marina, the process is the same.
                    </p>
                    <p>
                      We coordinate elevator access, manage fragile items and
                      heavy appliances, and work within the building&apos;s
                      moving rules.
                    </p>
                  </>
                ),
                extra: (
                  <>
                    <p>
                      ...
                      service covers home shifting dubai and house shifting
                      dubai needs across all residential towers in the city.
                    </p>
                  </>
                ),
                img: {
                ...
                description: (
                  <>
                    <p>
                      ...
                      ours. We work weekends and evenings to avoid disrupting
                      your operations.
                    </p>
                    <p>
                      As{" "}
              ...
              },
              {
                ...
                description: (
                  <>
                    ...
                    <p>
                      We also handle antiques, heavy wardrobes, modular
                      shelving, and oversized items that standard movers
                      won&apos;t touch.
                    </p>
                    <p>
                      As{" "}
                      ...
                      residents trust, we bring the right tools and proper
                      padding for every job.
                    </p>
                  </>
                ),
                extra: <></>,
              ...
              },
              {
                ...
                description: (
                  <>
                    <p>
                      Full professional packing using proper materials —
                      cardboard boxes, bubble wrap, stretch film, and furniture
                      pads.
                    </p>
                    <p>
                    ...
                    <p>
                      ...
                      cover everything from fragile kitchenware to electronics
                      and artwork.
                    </p>
                  </>
                ),
              ...
              },
              {
                ...
                description: (
                  <>
                    <p>
                      If your new property is not ready, or you need somewhere
                      to keep furniture during a renovation, we offer both
                      managed furniture storage and self-storage options.
                    </p>
                    <p>
              ...
              },
              {
                ...
                extra: (
                  <>
                    <p>
                      We have handled moves for banks, hospitals, restaurants,
                      and warehouses — all with the same transparent pricing
                      model.
                    </p>
                  </>
                ),
        ...
        >
          ...
          <div className="text-center">
            ...
            <p className="text-base sm:text-lg text-muted-foreground max-w-2xl mx-auto mt-2">
              As a general guide from our experience as a moving company in
              dubai:
            </p>
          </div>
          ...
          <div className="text-base sm:text-lg text-muted-foreground max-w-4xl mx-auto mt-10">
            <p>
              ...
              between locations, volume of items, and whether packing services
              are needed.
            </p>
            <p className="mt-2">
            ...
            <p className="mt-5">
              We tell you the full price before the job starts. Nothing changes
              on moving day — no additional charges, no fuel surcharge, no
        ...
        <section className="mx-auto w-full max-w-7xl md:px-10 px-4 mt-20">
          ...
          <p className="mt-3  text-center md:text-lg text-muted-foreground mx-auto max-w-3xl">
            ...
            industrial areas across Dubai. Below are the main areas where we
            work regularly as local movers in dubai.
          </p>
