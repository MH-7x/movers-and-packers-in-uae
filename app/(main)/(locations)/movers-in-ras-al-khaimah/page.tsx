...
const features = [
  ...
  },
  {
    ...
    buttonText: "View pricing guide",
    link: "/blogs/movers-and-packers-cost-in-dubai",
  },
  {
...
export default function RasAlKhaimahMoversPage() {
  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-background text-foreground">
        ...
        <section
          id="movers-and-packers-in-ras-al-khaimah-services"
            ...
            {[
              {
                ...
                extra: (
                  <>
                    <p>
                      For <Link href="/house-shifting-dubai" className="text-primary hover:underline">home movers</Link>{" "}
              ...
              },
              {
                ...
                description: (
                  <p>
                    <Link href="/villa-movers-in-dubai" className="text-primary hover:underline">Villa moving</Link>{" "}
              ...
              },
              {
                ...
                description: (
                  <p>
                    <Link href="/apartment-movers-dubai" className="text-primary hover:underline">
                      Apartment moves
                    </Link>{" "}
              ...
              },
              {
                ...
                description: (
                  <p>
                    <Link href="/office-movers-in-dubai" className="text-primary hover:underline">
                      Office relocation
                    </Link>{" "}
              ...
              },
              {
                ...
                extra: (
                  <>
                    <p>
                      Our{" "}
                      <Link href="/furniture-moving-services-uae" className="text-primary hover:underline">
                        furniture movers
                      </Link>{" "}
              ...
              <div
                key={i}
                id={item.id}
                className="rounded-2xl p-5 bg-card border border-border shadow-xs hover:shadow-md transition-shadow flex flex-col justify-between"
              >
                <div>
                  ...
                  <div className="mt-3 text-muted-foreground flex flex-col gap-y-2 leading-relaxed text-sm">
                    {item.description}
                  </div>
                </div>

                {item.extra && (
                  <details className="group [&_summary::-webkit-details-marker]:hidden mt-4 pt-3 border-t border-border">
                    <summary className="flex gap-x-1 items-center text-primary font-medium cursor-pointer select-none">
        ...
        <section className="max-w-7xl mx-auto mt-20 md:px-10 px-4">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-10">
            {features.map((feature, index) => (
              <div
                key={index}
                className="group bg-card rounded-2xl py-8 px-6 sm:p-10 border border-border shadow-xs hover:shadow-md transition-all flex flex-col justify-between"
              >
                <div>
                ...
                <div className="mt-auto pt-5 border-t border-border">
                  <Link
                    href={feature.link}
                    className="text-primary font-semibold inline-flex items-center text-sm uppercase tracking-wide group-hover:translate-x-1 transition-transform"
                  >
                    {feature.buttonText}
        ...
        <section className="max-w-7xl w-full mx-auto mt-20 md:px-10 px-4">
          <div className="pb-8 border-b border-border text-center md:text-left">
            <h2 className="text-3xl sm:text-4xl font-bold mb-4">
              What Affects Moving Costs
              <span className="font-normal block sm:inline"> in Ras Al Khaimah</span>
            </h2>
          ...
          <ul className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-8 mt-10">
            {costFactors.map((factor, index) => {
              const Icon = factor.icon;
              return (
                <li key={index} className="flex items-start p-4 rounded-xl border border-border bg-card shadow-xs">
                  <div
                    className={`shrink-0 w-12 h-12 rounded-2xl ${factor.bgColor} ${factor.color} flex items-center justify-center shadow-xs`}
                  >
          ...
          <div className="mt-10">
            <div className="bg-linear-to-br from-red-50 to-red-100 rounded-2xl p-6 sm:p-8 flex flex-col lg:flex-row items-center justify-between gap-6 border border-red-200">
              ...
              <a
                ...
                target="_blank"
                className="shrink-0 inline-flex items-center justify-center gap-2 px-6 py-3 text-base font-semibold text-white transition-all duration-200 bg-green-600 hover:bg-green-700 border border-transparent rounded-xl focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-600 shadow-md w-full sm:w-auto"
              >
        ...
        {/* Service Coverage Reference Section */}
        <section className="max-w-7xl mx-auto mt-20 md:px-10 px-4">
          ...
          <div className="grid md:grid-cols-3 lg:grid-cols-4 grid-cols-1 gap-6 mt-10">
            {[
              {
              ...
              <div
                key={i}
                className="bg-card p-5 rounded-xl border border-border shadow-xs hover:border-primary/50 transition-colors flex flex-col justify-between"
              >
                <div>
                  <h3 className="mb-2 font-bold text-base text-foreground">{feature.title}</h3>
        ...
        {/* Inter-Emirate Links Card */}
        <section className="max-w-7xl mx-auto px-4 md:px-10 mt-20 mb-20">
          <div className="bg-muted border border-border rounded-3xl p-6 sm:p-8 lg:px-12 text-center sm:text-left">
        ...
        <CTA
          ...
          desc="Movers and Packers in UAE has been handling moves in Ras Al Khaimah since 1998. Our team will send you an itemised quote on WhatsApp within the hour — no hidden charges, no pressure, no commitment required. You pay only after the job is done. Call or WhatsApp us today to get started."
        />
      </main>
    </>
  );
