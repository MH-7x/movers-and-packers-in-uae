        ...
        <Breadcrumb list={[
      {
        ...
        <QuotationSection
          title={
            <>
              ...
              From Movers and Packers in Al Ain
            </>
          }
        ...
        <section className="max-w-7xl mx-auto mt-20 md:px-10 px-4">
          ...
          <div className="text-center mb-10 max-w-4xl mx-auto">
            ...
            <p className="text-muted-foreground">
              ...
              experience and thousands of completed moves across the UAE. Our
              professional movers in Al Ain are trained, our trucks are
              RTA-approved, and every quote we send comes with zero hidden
              charges.
            </p>
            <p className="text-muted-foreground">
              Here&apos;s what makes us different from every other licensed
                ...
                extra: (
                  <>
                    ...
                    <p>
                      ...
                      , and apartment moves of every size. We&apos;re careful
                      with bedroom furniture, kitchen appliances, mirrors,
                      artwork, and anything that needs extra protection.
                    </p>
                  </>
                ),
                img: {
                ...
                extra: (
                  <>
                    <p>
                      ...
                      in Al Ain manage full office relocations,{" "}
                    ...
                    <p>
                      ...
                      freelance movers who have no legal permission to operate
                ...
                extra: (
                  <>
                    <p>
                      ...
                      in Al Ain handle single-item moves just as professionally
                      as full-house jobs. We also move specialist items: heavy
                      safes, industrial machinery, hospital equipment, and other
                      large or unusual pieces that most movers won&apos;t take
                      on. If you have a specific requirement, contact us and
                      we&apos;ll confirm what we can do.
                    </p>
                  </>
                ),
                img: {
                ...
                description: (
                  <>
                    <p>
                      ...
                      in Al Ain cover the full process — we bring materials,
                      pack everything, and label all boxes for easy unpacking at
                      the other end. You can hand the whole packing job to us or
                      we&apos;ll work alongside you, depending on what suits
                      you.
                    </p>
                  </>
                ),
                extra: (
                  <>
                    <p>
                      ...
                      new property, we provide curtain fixing and installation
            ...
            <div className="p-6 sm:p-12 border-b md:border-b-0 md:border-r border-slate-100 bg-red-50/50 ">
              ...
              <div className="space-y-4 text-slate-600 leading-relaxed">
                <p>
                  ...
                  covered compartment — completely protected from dust, sand,
                  and heat.
                </p>
            ...
            <div className="p-6 sm:p-12 hover:bg-slate-50/50 transition-colors duration-300">
              ...
              <div className="space-y-4 text-slate-600 leading-relaxed">
                ...
                <p>
                  ...
                  item being moved isn&apos;t sensitive to heat or dust
                  exposure.
                </p>
                <div className="bg-slate-50 rounded-xl p-4 mt-6 border border-slate-100">
                  <p className="text-sm flex items-start gap-3 text-slate-700">
                    ...
                    <span>
                      They are generally easier and faster to load and unload
                      for very straightforward jobs.
                    </span>
                  </p>
                </div>
              </div>
          ...
          <div className="bg-foreground mt-10 text-white p-6 sm:p-10 lg:px-12 flex flex-col md:flex-row items-center gap-6 md:gap-10 rounded-3xl">
            ...
            <div className="flex-1 text-center md:text-left">
              ...
              <p className="text-slate-300 text-base sm:text-lg ">
                ...
                residential or commercial move, we always recommend enclosed —
                and that&apos;s exactly what we use as our standard.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="bg-red-50/50 p-6 sm:p-8 border-t border-red-100 flex flex-col sm:flex-row items-start sm:items-center gap-4">
            ...
            <div>
              ...
              <p className="text-muted-foreground leading-tight">
                No additions, no last-minute extras. If you want to check how
                our rates compare in more detail, see our full moving prices
                page.
              </p>
            </div>
          </div>
        ...
        <section className="mt-20 max-w-7xl md:px-10 px-4 mx-auto">
          ...
          <p className="text-muted-foreground mt-5 text-center">
            Our movers in Al Ain cover every neighbourhood and district across
            the city. Below are the main areas we serve regularly.
          </p>
          ...
          <p className="text-muted-foreground mt-5 text-center max-w-4xl mx-auto">
            Don&apos;t see your area? We serve all of Al Ain. We also cover
            Dubai, Abu Dhabi, Sharjah, Ras Al Khaimah, Ajman, Fujairah, Umm Al
            Quwain, and all other UAE emirates from a single booking.
          </p>
        </section>
        <section className="max-w-7xl mx-auto px-4 md:px-10 mt-20 mb-20">
          <div className="bg-muted rounded-3xl p-6 sm:p-8 lg:px-12 text-center sm:text-left">
            <h3 className="text-xl sm:text-2xl font-bold mb-3">
              Inter-City Moves: Relocating from Al Ain
            </h3>
        ...
        <section className="max-w-4xl mx-auto mt-10 md:px-0 px-4 flex flex-col gap-y-5">
          <div>
            ...
            <p className="text-muted-foreground mt-3">
              Here&apos;s a straightforward summary of what you get when you
              book with us.
            </p>
            <div className="text-muted-foreground flex flex-col gap-y-1 mt-2">
              <ul className="list-inside list-disc">
                <li>
                  Founded 1998 — over 25 years of moving experience across the
                  UAE
                </li>
                ...
                <li>
                  No hidden charges — your quoted price is your final price
                </li>
                <li>
                  Pay Upon Satisfaction — you pay only when you&apos;re happy
                  with the result
                </li>
                <li>Same-day urgent service available for unexpected moves</li>
                <li>
                  Verified Google Business Profile — check our reviews and
