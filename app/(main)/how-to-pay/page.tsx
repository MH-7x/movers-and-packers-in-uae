          ...
          <div className="bg-white rounded-2xl shadow-lg border border-stone-100 p-8 md:p-10">
            <div className="flex items-start md:flex-row flex-col gap-5">
              ...
              <div>
                ...
                <p className="text-stone-600 leading-relaxed mb-3">
                  We don&apos;t ask for large upfront payments and then
                  disappear. We&apos;re a registered company with a real
                  address, a verified Google Business listing, and 25+ years of
                  history in UAE. We&apos;re not going anywhere.
                </p>
                <p className="text-stone-600 leading-relaxed">
                  Once our team finishes the job, you inspect everything, and
                  then you pay. That&apos;s how it works.
                </p>
              </div>
            </div>
          </div>
            ...
            <div>
              ...
              <div className="bg-white/5 border border-white/10 rounded-xl px-5 py-4 mb-5">
                <p className="text-stone-300 text-sm leading-relaxed">
                  ...
                  <span className="text-primary font-semibold">800 AED</span>,
                  you pay{" "}
                  <span className="text-primary font-semibold">800 AED</span>.
              ...
              <p className="text-stone-400 leading-relaxed text-sm">
                This is one reason we put everything in writing — on your
                WhatsApp or email — so you can refer back to it at any time.
              </p>
            </div>
          ...
          <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-8">
            ...
            <div className="bg-white rounded-2xl border border-stone-100 p-7">
              ...
              <p className="text-stone-600 text-sm leading-relaxed">
                ...
                clear quote before anything begins. Same rules, same
                transparency, just a faster timeline.
              </p>
          ...
          <div className="max-w-4xl mx-auto flex flex-col md:flex-row items-center justify-between gap-8">
            <div>
              ...
              <p className="text-white/70 text-sm">
                Just call or WhatsApp us — we&apos;ll walk you through
                everything.
              </p>
            </div>
