      ...
      <main>
        ...
        <section className="mt-16 max-w-4xl mx-auto md:px-0 px-4">
          ...
          <p className="md:text-2xl text-lg font-bold text-center mt-3">
            With 25+ years of commercial moving experience and a foundation
            built on{" "}
        ...
        <div className="max-w-7xl md:px-10 mx-auto mt-20 grid lg:grid-cols-6 grid-col-1 min-h-screen gap-10">
          ...
          >
            ...
            <section>
              ...
              <p>
                Our expertise covers all types of hospital and clinical
                furniture found in healthcare facilities across the UAE:
              </p>
            ...
            <section>
              ...
              <p>
                Our systematic, healthcare-focused approach ensures your
                facility move is handled with precision and minimal disruption:
              </p>
            ...
            <section>
              ...
              <ul className="list-inside list-disc mt-5 text-muted-foreground leading-relaxed space-y-3">
                ...
                <li>
                  <strong>
                    Team trained in careful, professional handling
                  </strong>{" "}
                  of clinical environments
                </li>
                <li>
                  <strong>Fully Enclosed Box Trucks</strong> protect items
                  during UAE&apos;s extreme heat and sandstorms
                </li>
                <li>
                  <strong>Protection and Privacy</strong> — our founding
                  principle — is especially critical in healthcare settings
                </li>
                <li>
