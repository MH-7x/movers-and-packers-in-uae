          ...
          >
            <section>
              ...
              <p className="mt-2">
                ...
                equipped, and part of a licensed business that has been
                operating in the UAE for over 25 years. That means real
                accountability, real insurance, and a team that shows up on
                time.
              </p>
            ...
            <div className="bg-secondary rounded-3xl aspect-video relative overflow-hidden">
              <Image
                src={
                  "/ser/apartment-movers-in-dubai-crew-with-moving-truck.jpg"
                }
            ...
            <section>
              ...
              <p>
                We handle your Dubai apartment relocation in five clear steps —
                no confusion, no surprises. Here is what to expect when you book
                with our apartment movers in Dubai.
              </p>
            ...
            <section>
              ...
              <div className="flex flex-col gap-y-1">
                <p>
                  Movers and Packers in UAE was established in 1998 — that is
                  over 25 years of legally operating in the UAE, verifiable
                  through our trade registration.
                </p>
                <p>
                  ...
                  relocations and built our reputation entirely on repeat
                  business and word of mouth.
                </p>
                <p>
                  We operate under a clear philosophy of Protection and Privacy
                  — which matters especially when movers are handling bedroom
                  items, personal belongings, and household valuables.
                </p>
                <p>
                  Our team communicates in both English and Arabic, so language
                  is never a barrier.
                </p>
                <p>
                ...
                <p>
                  We are not a call centre. We are a family business that has
                  been doing this work for a long time, and we stand behind
                  every move we complete.
                </p>
              </div>
            </section>
          </div>
