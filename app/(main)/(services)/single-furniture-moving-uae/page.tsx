        ...
        <section className="mt-16 max-w-4xl mx-auto md:px-0 px-4">
          <div className="md:text-lg text-muted-foreground text-center mt-10 md:px-20 space-y-4">
            <p>
              ...
              Fujairah, and Umm Al Quwain, we are the trusted name for furniture
              pick up and delivery across all emirates.
            </p>
            <Link
        ...
        <div className="max-w-7xl md:px-10 mx-auto mt-20 grid lg:grid-cols-6 grid-col-1 min-h-screen gap-10">
          ...
          >
            <section>
              ...
              <p>
                Single furniture moving — sometimes called one-item moving,
                single piece furniture delivery, or furniture transport for a
                single item — is a specialized service for customers who only
                need to move one or a few individual furniture pieces. This is
                different from a full house move and is priced accordingly — far
              ...
              <ul className="list-inside list-disc mt-4 text-muted-foreground leading-relaxed space-y-2">
                ...
                <li>
                  Moving single furniture in house from one room to another or
                  one floor to another
                </li>
                <li>
                  Office furniture rearrangement — moving a single desk or
                  filing cabinet
                </li>
              </ul>
            </section>
            ...
            <section>
              ...
              <ul className="list-inside list-disc mt-4 text-muted-foreground leading-relaxed space-y-2">
                <li>
                  The type and size of the furniture piece (sofa vs. wardrobe
                  vs. safe)
                </li>
            ...
            <section>
              ...
              <ul className="list-inside list-disc mt-6 text-muted-foreground leading-relaxed space-y-2">
                ...
                <li>
                  Serving Dubai, Abu Dhabi, Sharjah, Ajman, Al Ain, RAK,
                  Fujairah, UAQ
                </li>
            ...
            <section>
              ...
              <div className="flex flex-col gap-y-3 text-muted-foreground">
                <p>
                  ...
                  paying for a full-truck service you do not need. You are
                  paying for exactly what you get — professional handling of one
                  item.
                </p>
                <p>
          ...
          <aside className="lg:col-span-2 flex flex-col gap-y-5 self-start sticky top-24 md:px-0 px-4">
            <div className="rounded-2xl bg-muted p-6 space-y-3">
              ...
              <p className="text-sm text-muted-foreground">
                ...
                We specialize in moving small and single furniture moving in
                uae.
              </p>
