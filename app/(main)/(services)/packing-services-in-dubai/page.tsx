      ...
      <main>
        ...
        <section className="mt-16 max-w-4xl mx-auto md:px-0 px-4">
          <div className="md:text-lg text-muted-foreground text-center mt-10 md:px-20">
            <p>
              Our trained packers use professional materials — from bubble wrap
              to custom wooden crates — to make sure your belongings reach their
          ...
          >
            <section>
              ...
              <p>
                ...
                and sandstorms can show up without much warning. If your items
                are not properly packed and protected, the results can be
                costly.
              </p>
              <p className="mt-2">
                ...
                dust. Glassware breaks because it wasn&apos;t cushioned
                properly.
              </p>
              <p className="mt-2">
                And when you are already managing a move, the last thing you
                want is to open boxes and find broken belongings.
              </p>
              <p className="mt-2">
                That&apos;s where professional packing and moving services make
                a real difference:
              </p>
              <ul className="grid md:grid-cols-3 grid-cols-1 gap-3 mt-3 leading-tight">
                ...
                <li className="bg-secondary py-3 px-4 rounded-2xl">
                  ✔ Pay upon satisfaction — you only pay once the job is
                  completed and you are happy with it
                </li>
              </ul>
              <p className="mt-5">
                And that last point is something no competitor in Dubai
                currently offers. We stand behind our work.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                ...
                move — residential or commercial, local or international.
                Whether you need someone to pack a single item or an entire
                warehouse, we can handle it.
              </p>
              ...
              <div className="flex flex-col gap-y-1">
                <p>
                  ...
                  or house is a big job. There are kitchen items wrapped in
                  layers of grease and memories, fragile décor you&apos;ve
                  collected over the years, electronics, clothing, and furniture
                  — all in one place. Our team handles it all.
                </p>
                <p>
                ...
                <p>
                  ...
                  Furniture is dismantled by our certified carpenters where
                  needed and reassembled at your new location.
                </p>
                <p>
                  This service works well for apartments, flats, and houses
                  across Dubai and all emirates. It covers{" "}
              ...
              <div className="flex flex-col gap-y-1">
                <p>
                  ...
                  custom fixtures that need extra care. Standard packing
                ...
                <p>
                  We also recommend our fully enclosed box trucks for villa
                  moves — they protect your belongings from Dubai&apos;s summer
                  heat and sandstorm dust in a way that an open truck simply
                  cannot.
                </p>
              </div>
              ...
              <div className="flex flex-col gap-y-1">
                <p>
                  ...
                  Computers, monitors, servers, and confidential documents
                  cannot be thrown into a box and hoped for the best. Department
              ...
              <div className="flex flex-col gap-y-1">
                <p>
                  Not every move is a full relocation. Sometimes you just need
                  to move a single sofa, a dining table, or a heavy safe. We
                  offer single furniture moving with the same level of care we
                  give to full-home moves.
                </p>
                <p>
                  For larger operations — warehouses, industrial equipment,
                  machinery — our team has the experience and equipment to
                  handle it. We have moved heavy safes, industrial machinery,
                  and warehouse-scale inventory across UAE. If you need it
                  moved, we can pack it.
                </p>
              </div>
              ...
              <div className="flex flex-col gap-y-1">
                ...
                <p>
                  We use moisture-resistant wrapping, vacuum sealing for
                  sensitive items, heat-treated wooden crates, and
                  internationally compliant labeling for all cargo shipments.
                  Every package is built to survive the journey — whether it is
                  going to another emirate or another country.
                </p>
              </div>
              ...
              <div className="flex flex-col gap-y-1">
                ...
                <p>
                  We use dust-proof wrapping, double-layer protection for
                  fragile items, and moisture-resistant sealing to keep your
                  belongings clean and safe while in storage. Everything is
                  labeled clearly so retrieval is easy. This service pairs well
                  with our storage facilities if you need a place to keep your
                  items while you are between locations.
                </p>
              </div>
              ...
              <div className="flex flex-col gap-y-1">
                ...
                <p>
                  We assess each fragile item individually before deciding how
                  to pack it. Layers of bubble wrap, foam sheets, padded corner
                  guards, and custom wooden crates are used based on the
                  item&apos;s value, size, and fragility. If it matters to you,
                  it matters to us.
                </p>
              </div>
            </section>
            <section>
              ...
              <p>
                ...
                belongings are during a move. We do not cut corners here. Our
                team arrives with everything needed — you do not have to buy or
                arrange a single thing.
              </p>
              <p className="mt-">Here is what we bring:</p>
              <ul className="grid md:grid-cols-3 grid-cols-1 gap-3 mt-3 leading-tight">
                <li className="bg-secondary py-3 px-4 rounded-2xl">
                  <span className="font-medium">Heavy-duty carton boxes</span>{" "}
                  in multiple sizes — matched to the type and volume of items
                </li>
                <li className="bg-secondary py-3 px-4 rounded-2xl">
                  <span className="font-medium">Bubble wrap</span> for fragile
                  and delicate items — glassware, electronics, décor
                </li>
                <li className="bg-secondary py-3 px-4 rounded-2xl">
              ...
              <p className="mt-5">
                ...
                protected during transit. In a city where summer temperatures
                stay above 45°C for months, and sandstorms are a regular
                reality, an open truck is a genuine risk. Our enclosed trucks
                are not an upgrade — they are the standard.
              </p>
            </section>
            <section>
              ...
              <p className="mt-5">
                Every step is managed by our team. You are updated throughout
                the process.
              </p>
            </section>
            ...
            <section>
              ...
              <div className="grid md:grid-cols-3 grid-cols-1 gap-5 mt-8">
                {[
                  ...
                  },
                  {
                    ...
                    description:
                      "Machinery, heavy safes, large-scale equipment",
                  },
                  {
              ...
              <p className="mt-5">
                ...
                and moving company is not optional — it is a protection.
                Freelance movers operate without official permits, which means
                if something goes wrong with your equipment or assets, you have
                very little recourse. We are registered, insured, and
                accountable.
              </p>
            </section>
            <section>
              ...
              <ul className="text-muted-foreground mt-5 list-disc list-inside leading-tight">
                ...
                <li>
                  <b>Distance —</b> A move within Dubai is priced differently
                  from a move to Abu Dhabi or Ras Al Khaimah
                </li>
              </ul>
              <p className="mt-5">
                What we promise is this: the quote you receive is the price you
                pay. If we quote you 1,000 AED, you pay 1,000 AED. No
                last-minute additions. No surprise charges when the job is done.
              </p>
              <p className="mt-2">
            ...
            <section>
              ...
              <p>
                We have been doing this since 1998. That is more than 25 years
                of completed moves across the UAE — a track record that most
                moving companies in Dubai simply do not have.
              </p>
              ...
              <p className="mt-5">
                We built this company on the principles of Protection and
                Privacy. That matters particularly when strangers are entering
                your home to pack bedroom and kitchen items. Our team is
                trained, professional, and fully vetted.
              </p>
              <p className="mt-2">
            ...
            <section>
              ...
              <p>
                Our packing and moving services are not limited to Dubai. We
                cover all seven emirates and can be reached from anywhere in the
                UAE by a single call or WhatsApp message.
              </p>
            ...
            <section>
              ...
              <p>
                If you are handling some of the packing yourself, or just want
                to be prepared before our team arrives, these tips are specific
                to moving in the UAE — not generic advice you&apos;ll find
                anywhere.
              </p>
              ...
              <ul className="text-muted-foreground mt-5 list-disc list-inside leading-tight flex flex-col gap-y-1">
                <li>
                  ...
                  rooms, storage rooms, and rarely-used cabinets should be
                  packed 1–2 weeks before your move date. Leave daily essentials
                  for last.
                </li>
                <li>
                  <strong>
                  ...
                  creates static buildup that can damage sensitive components.
                  Use anti-static bags or wrap before boxing.
                </li>
                <li>
                  <strong>
                ...
                <li>
                  ...
                  boxes are stacked, you can only see the sides. Side labels
                  save a lot of time during unloading.
                </li>
                <li>
                  <strong>
                    Pack a &quot;first-night kit&quot; separately.
                  </strong>{" "}
                ...
                <li>
                  <strong>Match box size to item weight.</strong> Heavy items
                  like books and crockery go in small boxes. Light items like
                  bedding and pillows go in large ones. Mixing this up leads to
                  boxes that are too heavy to carry safely.
                </li>
                <li>
                  <strong>
                  ...
                  sound system saves considerable frustration when you are
          ...
          <aside className="lg:col-span-2 flex flex-col gap-y-5 self-start sticky top-24 md:px-0 px-4">
            <div className="rounded-2xl bg-muted p-6 space-y-3">
              ...
              <p className="text-sm text-muted-foreground">
                Contact our packing team today for a free consultation and
                quote. We specialize in packing for moving, cargo and for
                storage.
              </p>
