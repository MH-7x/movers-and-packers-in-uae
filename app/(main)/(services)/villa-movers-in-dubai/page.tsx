    ...
    <>
      ...
      <main>
        ...
        <p className="max-w-4xl mx-auto mt-16 md:text-lg md:px-0 px-4">
          ...
          goes smoothly, your items arrive in perfect condition, and the price
          you agreed on is the price you pay.
        </p>
        ...
        <div className="max-w-7xl md:px-10 mx-auto mt-20 grid lg:grid-cols-6 grid-col-1 min-h-screen gap-10">
          ...
          >
            <section>
              ...
              <p className="mt-2">
                They carry no insurance, which means if your antique cabinet
                gets scratched, your TV breaks during transit, or a piece of
                furniture simply disappears, there is nothing you can do. No
                contract, no accountability, no claim process.
              </p>
              <p className="mt-2">
                There is also the privacy issue. Villa moves involve access to
                bedrooms, storage rooms, and the most private areas of your
                home. Hiring unverified workers puts your household at risk in
              ...
              <p>
                Here is the practical difference between hiring a registered
                mover like us versus a freelance operator:
              </p>
              <div className="grid md:grid-cols-2 grid-cols-1 gap-10 mt-5">
                ...
                <div>
                  ...
                  <ul className="mt-3 text-muted-foreground leading-tight list-disc list-inside flex flex-col gap-y-2">
                    ...
                    <li>
                      No accountability if items are damaged, delayed, or
                      missing
                    </li>
                  </ul>
                </div>
            ...
            <div className="bg-secondary rounded-3xl aspect-video relative overflow-hidden">
              <Image
                src={
                  "/ser/villa-moving-company-in-dubai-truck-outside-villa.jpg"
                }
            ...
            <section>
              ...
              <p>
                ...
                2-bedroom villa in Al Barsha to a sprawling 7-bedroom compound
                in Emirates Hills.{" "}
              </p>
              <p className="mt-2">
                Our villa movers and packers in Dubai handle the full process,
                so you do not have to coordinate multiple contractors or worry
                about anything getting missed. Here is what is included:
              </p>
              <h3 className="mt-5 mb-3!">
                Pre-Move Assessment & Custom Moving Plan
              </h3>
              <p className="mt-2">
                Before moving day, we send a team member to your villa for a
                free site survey. They walk through every room, document all
                items, identify fragile or oversized pieces, check elevator
                access and parking, and note anything that needs special
                handling.
              </p>
              <p className="mt-2">
                From this visit, we build a room-by-room moving plan and send
                you a fully itemised quote via WhatsApp and email. Nothing is
                left vague. You know the price, the timeline, and exactly what
                is covered before we start.
              </p>
              <h3 className="mt-5 mb-3!">
              ...
              <ul className="grid md:grid-cols-3 grid-cols-1 gap-3 mt-3">
                ...
                <li className="bg-secondary py-2 px-3 rounded-2xl leading-tight">
                  <span className="font-medium">Stretch film —</span>{" "}
                  waterproofs items during outdoor loading and unloading
                </li>
                <li className="bg-secondary py-2 px-3 rounded-2xl leading-tight">
              ...
              <p className="mt-1">
                We also offer curtain fixing and installation as an add-on, so
                you are fully settled in from day one.
              </p>

              <h3 className="mt-5">Safe Loading, Transport & Unloading</h3>
              <p>
                We operate RTA-approved, fully enclosed box trucks — available
                in 3-ton and 4-ton capacity. The enclosed design is not just a
              ...
              <p className="mt-1">
                ...
                upholstered pieces, wooden finishes, and anything with a screen
                or circuit board.
              </p>
              <p className="mt-1">
                Our enclosed trucks keep your items in a protected, shaded
                environment from loading to arrival. Every item is secured
                before the truck moves, and our drivers know Dubai&apos;s roads
                well.
              </p>

              <h3 className="mt-5">Unpacking & Setup at Your New Villa</h3>
              <p>
                If you want full-service, we offer an optional unpacking
                service.
              </p>
              <p className="mt-1">
                The team unpacks every box, places furniture according to your
                instructions, and removes all packing waste before they leave.
                You walk into a ready home — not a maze of cardboard.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                Here is exactly what happens from the moment you contact us to
                the moment you are settled in your new villa:
              </p>
            ...
            <section>
              ...
              <ul className="grid md:grid-cols-3 grid-cols-1 gap-3 mt-3 leading-tight ">
                <li className="bg-secondary py-2 px-3 rounded-2xl ">
                  <span className="font-medium">Jumeirah 1, 2 & 3 —</span>{" "}
                  classic villa areas with mixed street and compound layouts
                </li>
                <li className="bg-secondary py-2 px-3 rounded-2xl ">
                  <span className="font-medium">Emirates Hills —</span> large
                  compounds with high-value residences and strict community
                  rules
                </li>
                <li className="bg-secondary py-2 px-3 rounded-2xl ">
                  <span className="font-medium">
                ...
                <li className="bg-secondary py-2 px-3 rounded-2xl ">
                  <span className="font-medium">Al Barsha —</span> popular
                  family villa area with easy road access
                </li>
                <li className="bg-secondary py-2 px-3 rounded-2xl ">
                ...
                <li className="bg-secondary py-2 px-3 rounded-2xl ">
                  <span className="font-medium">Nad Al Sheba —</span> large
                  villa plots, often requiring bigger truck capacity
                </li>
                <li className="bg-secondary py-2 px-3 rounded-2xl ">
                  <span className="font-medium">
            ...
            <section>
                ...
                <table className="w-full text-left border-collapse">
                  <thead>
                    <tr className="bg-foreground border-b border-gray-200 text-white font-semibold">
                      ...
                      <th className="py-4 px-6 text-sm">
                        Estimated Price (AED)
                      </th>
              ...
              <p className="mt-2">
                When you contact us, we will give you a custom quote that
                accounts for your specific situation. What we guarantee is this:
                the price in your quote is the price you pay. No hidden charges,
                no surprise fees at the end of the job.
              </p>
            </section>
            <div className="bg-secondary rounded-3xl aspect-video relative overflow-hidden">
              <Image
            ...
            <section>
              ...
              <p>
                ...
                who research properly tend to choose us — and why they come
                back:
              </p>
            ...
            <section>
              ...
              <p>
                Not every moving company has the equipment or experience to
                handle unusual or high-value items. We do. Beyond standard
                furniture, our team regularly moves:
              </p>
              <ul className="grid md:grid-cols-3 grid-cols-1 gap-3 mt-3 leading-tight">
                <li className="bg-secondary py-2 px-3 rounded-2xl">
            ...
            <section>
              ...
              <p>
                Villa moves often involve a gap between your vacate date and
                your move-in date. Rather than leaving furniture with friends or
                paying for temporary accommodation just to store your
                belongings, we offer proper storage options:
              </p>
              <ul className="grid md:grid-cols-2 grid-cols-1 gap-3 mt-3 leading-tight">
                ...
                <li className="bg-secondary py-2 px-3 rounded-2xl">
                  Flexible duration — daily, weekly, or monthly, depending on
                  your timeline
                </li>
                <li className="bg-secondary py-2 px-3 rounded-2xl">
          ...
          <aside className="lg:col-span-2 flex flex-col gap-y-5 self-start sticky top-24 md:px-0 px-4">
            <div className="rounded-2xl bg-muted p-6 space-y-3">
              ...
              <p className="text-sm text-muted-foreground">
                Contact our moving and packing team today for a free
                consultation and quote. We specialize in relocating all sizes of
                villa in dubai and other locations.
              </p>
