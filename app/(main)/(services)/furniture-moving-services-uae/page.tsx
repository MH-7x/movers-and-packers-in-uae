        ...
        <Breadcrumb list={[
      {
        ...
        <section className="mt-16 max-w-4xl mx-auto md:px-0 px-4">
          <div className="md:text-lg text-muted-foreground text-center mt-10 md:px-20 space-y-4">
            ...
            <p>
              Our 25+ years of on-the-ground experience in the UAE moving
              industry means we know every challenge — from high-rise elevator
              bookings to extreme summer heat — and we are fully prepared to
              handle them all.
            </p>
          ...
          >
            <section>
              ...
              <p>
                ...
                price. It is about trust, reliability, and knowing your items
                will arrive safely. Here is what sets us apart from freelance
                movers and unregistered companies.
              </p>
              <ul className=" mt-6 text-muted-foreground gap-3 grid md:grid-cols-2 grid-cols-1 leading-tight">
                <li className="p-3 bg-secondary rounded-2xl">
                  Officially registered moving company since 1998 — fully
                ...
                <li className="p-3 bg-secondary rounded-2xl">
                  Transparent pricing — what you see in the quote is exactly
                  what you pay, nothing more
                </li>
                <li className="p-3 bg-secondary rounded-2xl">
                  Pay Upon Satisfaction: we only collect payment after the job
                  is complete and you are happy
                </li>
                <li className="p-3 bg-secondary rounded-2xl">
                ...
                <li className="p-3 bg-secondary rounded-2xl">
                  Verified Google Business Profile — check our real reviews
                  before booking
                </li>
                <li className="p-3 bg-secondary rounded-2xl">
                  No freelance, no phone-only operators — a real company with
                  real accountability
                </li>
              </ul>
            </section>
            ...
            <section>
              ...
              <ul className="list-inside list-disc mt-3 text-muted-foreground leading-tight space-y-2">
                ...
                <li>
                  School desks, classroom chairs, library shelving, lab
                  furniture
                </li>
                <li>
            ...
            <section>
              ...
              <ul className="list-inside list-disc mt-6 text-muted-foreground leading-relaxed space-y-2">
                <li>
                  No legal registration or DED license — no accountability if
              ...
              <p className="mt-6">
                As a company registered since 1998 with a verified Google
                Business Profile, a real address, and thousands of completed
                moves, we are the safe and accountable alternative. Meet our
                owner, check our reviews, and book with confidence.
              </p>
            </section>
            ...
            <section>
              ...
              <ul className="list-inside list-disc mt-4 text-muted-foreground leading-relaxed space-y-2">
                ...
                <li>
                  Timing — standard scheduling vs. same-day urgent service
                </li>
              </ul>
              <p className="mt-6">
            ...
            <section>
              ...
              <div className="flex flex-col gap-y-3 text-muted-foreground">
                ...
                <p>
                  ...
                  24/7, and fully insured. We stand behind every move we
                  complete, which is why thousands of families and businesses
                  across the UAE continue to trust us.
                </p>
                <p>
                  For commercial relocations — offices, banks, hospital
                  furniture, school setups, or restaurant fit-outs — you can
                  arrange a direct meeting with the company owner to discuss
