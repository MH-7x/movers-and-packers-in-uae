...
import imgSrc from "@/public/movers-and-packers-in-uae.jpg";
          ...
          <div className="grid lg:grid-cols-12 gap-16 lg:gap-8 items-center">
            ...
            <div className="lg:col-span-7 flex flex-col justify-center">
              ...
              <h1 className="text-3xl md:text-left text-center md:text-5xl font-bold leading-[1.1] mb-6 text-foreground md:tracking-tight">
                ...
                <span className="md:block text-transparent bg-clip-text bg-gradient-to-r from-red-600 to-[#c10007] mt-2">
